...
class ComplicationController: NSObject, CLKComplicationDataSource {
    ...
    */
    private func getModularSmallTemplate(bicycles: Int, parkings: Int) -> CLKComplicationTemplateModularSmallColumnsText {
    ...
    /**
       ...
       - Parameter parkings: Number of parking spots available
    */
    private func getUtilitarianSmallTemplate(bicycles: Int, parkings: Int) -> CLKComplicationTemplateUtilitarianSmallFlat {
        if (bicycles != 0 && parkings != 0) {
            bicycleValueProvider.text = "\(bicycles)"
            parkingValueProvider.text = "\(parkings)"
        }
        ...
        template.textProvider = CLKTextProvider(format: "%@ %@ %@ %@", bicycleTextProvider, bicycleValueProvider, parkingTextProvider, parkingValueProvider)
        return template
    }
    ...
    /**
       ...
       - Parameter parkings: Number of parking spots available
    */
    private func getCircularSmallTemplate(bicycles: Int, parkings: Int) -> CLKComplicationTemplateCircularSmallStackText {
        if (bicycles != 0 && parkings != 0) {
            bicycleValueProvider.text = "\(bicycles)"
            parkingValueProvider.text = "\(parkings)"
        }
    ...
    /**
        ...
        - Parameter parkings: Number of parking spots available
     */
    private func getGraphicCornerTemplate(bicycles: Int, parkings: Int) -> CLKComplicationTemplateGraphicCornerGaugeText {
        ...
        template.gaugeProvider = CLKSimpleGaugeProvider(style: .ring, gaugeColors: isUnknown ? [UIColor.gray] : colors, gaugeColorLocations: locations, fillFraction: fraction)
        return template
    }
    ...
    /**
       ...
       - Parameter parkings: Number of parking spots available
    */
    private func getGraphicCircularTemplate(bicycles: Int, parkings: Int) -> CLKComplicationTemplateGraphicCircularOpenGaugeRangeText {
        let isUnknown = bicycles == 0 && parkings == 0
        var fraction = Float(bicycles) / Float(bicycles + parkings)
        var locations: [NSNumber] = []
